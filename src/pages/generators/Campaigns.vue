...
import { ref } from 'vue';
import { Settings2, BookMarkedIcon } from 'lucide-vue-next';
...
<template>
  ...
  <div id="quest-generator" class="flex flex-col max-h-full px-6 pb-6 pt-12 space-y-12">
    ...
    <div id="title" class="space-y-1">
        ...
        <BookMarkedIcon stroke-width="2" :size="40"/>
        <h2 class="text-heading-lg font-medium">Campaign Generator</h2>
      </div>
      <span class="text-heading-xm font-normal text-slate-500">Create epic journeys with a click</span>
    </div>
